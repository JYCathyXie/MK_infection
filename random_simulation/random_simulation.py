...
# Output
np.savetxt('PATH\\closer_high_percentage.txt',hi_perc_arr)
np.savetxt('PATH\\closer_low_percentage.txt',lo_perc_arr)
np.savetxt('PATH\\closer_high_mean_dist.txt',hi_mean_arr)
np.savetxt('PATH\\closer_low_mean_dist.txt',lo_mean_arr)
